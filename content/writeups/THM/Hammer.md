...
![[Screenshot 2024-08-31 alle 10.04.17.png]]


So we can start trying all possible codes, with ffuf or with burp:

![[Screenshot 2024-08-31 alle 10.06.06.png]]

we set recevory_code as placeholder for our payloads and try all numbers from 0 to 9999  (padded to 4 digits length)
...
![[Screenshot 2024-08-31 alle 10.09.30.png]]

It may be possible that we have to restart the password reset from scratch (because in the meanwhile time has passed and our session is no longer valid for password reset).
...
![[Screenshot 2024-08-31 alle 10.19.41.png]]


![[Screenshot 2024-08-31 alle 10.19.28.png]]
...
![[Screenshot 2024-08-31 alle 10.26.50.png]]

![[Screenshot 2024-08-31 alle 10.27.49.png]]

In the same way we alter user and set role admin:
![[Screenshot 2024-08-31 alle 10.28.35.png]]
